...
namespace StonkBot.Migrations
{
    ...
    [Migration("20230115043133_CalculatedFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StonkBot.StonkBot.Database.Entities.IndustryAnalysis.IAHistoricalData", b =>
                {
                    b.OwnsOne("StonkBot.StonkBot.Database.Entities.IndustryAnalysis.CalculatedFields", "CalculatedFields", b1 =>
                        {
                            b1.Property<string>("IAHistoricalDataSymbol")
                                .HasColumnType("TEXT");

                            b1.Property<DateTime>("IAHistoricalDataDatetime")
                                .HasColumnType("TEXT");

                            b1.Property<string>("AboveUpperShadow")
                                .HasColumnType("TEXT");

                            b1.Property<string>("FiveDayStable")
                                .HasColumnType("TEXT");

                            b1.Property<string>("FourHand")
                                .HasColumnType("TEXT");

                            b1.Property<string>("FromYesterday")
                                .HasColumnType("TEXT");

                            b1.Property<bool?>("UpToday")
                                .HasColumnType("INTEGER");

                            b1.Property<bool?>("UpperShadow")
                                .HasColumnType("INTEGER");

                            b1.Property<string>("VolumeAlert")
                                .HasColumnType("TEXT");

                            b1.Property<string>("VolumeAlert2")
                                .HasColumnType("TEXT");

                            b1.HasKey("IAHistoricalDataSymbol", "IAHistoricalDataDatetime");

                            b1.ToTable("IAHistoricalData");

                            b1.WithOwner()
                                .HasForeignKey("IAHistoricalDataSymbol", "IAHistoricalDataDatetime");
                        });
